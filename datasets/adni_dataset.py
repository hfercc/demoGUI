...
class ADNI(Dataset):
    ...
    def __init__(self, csv_file, ids, data_path, mri=False, grey=False, white=False, csf=False, pet=False, suvr=False, dx=False, age=False, gender=False, edu=False, apoe=False, size=None, hippo=False, split=1, multi_modal=False, transform=False, noise=False):
        """
        Args:
